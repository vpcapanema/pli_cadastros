...
async function criarTabelasComplementares() {
  ...
  try {
    ...
    const configuracoesDefault = [
      ...
      [
        'email.remetente_padrao',
        'SIGMA-PLI <pli.semil.sp@gmail.com>',
        'Email remetente padrão',
        'STRING',
        'EMAIL',
      ],
      [
        'session.timeout_minutos',
        '1440',
        'Timeout de sessão em minutos (24h)',
        'INTEGER',
        'SEGURANCA',
      ],
      ['backup.retencao_dias', '30', 'Dias para manter backups', 'INTEGER', 'BACKUP'],
      [
        'auditoria.logs_retencao_dias',
        '90',
      ...
      [
        ...
        '30',
        'Intervalo de refresh do dashboard (segundos)',
        'INTEGER',
        'INTERFACE',
      ],
    ];
