        ...
        const tabelasNecessarias = [
            {
                ...
                colunas: ['id', 'usuario_id', 'acao', 'tabela_afetada', 'registro_id', 'dados_anteriores', 'dados_novos', 'ip_address', 'user_agent', 'created_at'],
                existe: tabelasExistentes.includes('logs_auditoria')
            },
            {
                nome: 'sessao_controle', 
                descricao: 'Controle de sessões de usuários',
                colunas: ['id', 'usuario_id', 'session_token', 'data_login', 'data_logout', 'ip_address', 'user_agent', 'ativo'],
