...
function initMasks() {
    ...
    if (cnaeInput) {
        cnaeInput.addEventListener('input', (e) => {
            ...
            if (value.length > 4) {
                e.target.value = value.substring(0, 4) + '-' + value.substring(4, 5) + '/' + value.substring(5);
    ...
    document.querySelectorAll('.btn-editar').forEach(btn => {
        btn.addEventListener('click', async () => {
            ...
            try {
                ...
                document.getElementById('modalTitle').innerHTML = '<i class="fas fa-building"></i> Editar Pessoa Jurídica';
                ...
                document.getElementById('dataAbertura').value = empresa.data_abertura ? empresa.data_abertura.split('T')[0] : '';
