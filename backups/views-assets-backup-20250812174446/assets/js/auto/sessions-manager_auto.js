...
DataTableScriptLoader.initDataTableScripts(['/static/js/pages/sessions-manager.js'])
  .then(() => {
...
document.getElementById('auto_evt_14965b10').addEventListener('click', function (event) {
  ...
  try {
    __result = function () {
      sessionsManager.cleanExpiredSessions();
    }.call(this, event);
  } catch (e) {
    console.error(e);
  }
