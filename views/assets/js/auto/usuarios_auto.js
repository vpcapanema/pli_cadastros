// moved from inline <script>
        ...
        DataTableScriptLoader.initUsuariosPage().then(() => {
...
document.getElementById("auto_evt_42d33e56").addEventListener("click", function(event) {
  var __result;
  try {
    __result = (function(){ aplicarFiltrosUsuarios() }).call(this, event);
...
document.getElementById("auto_evt_015f0f39").addEventListener("click", function(event) {
  var __result;
  try {
    __result = (function(){ limparFiltrosUsuarios() }).call(this, event);
  } catch(e) { console.error(e); }
  if (__result === false) { event.preventDefault(); event.stopPropagation(); }
});
